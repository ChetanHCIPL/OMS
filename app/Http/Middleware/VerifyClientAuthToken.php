...
class VerifyClientAuthToken
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $message = '';
        $USER_AUTH_TOKEN_EXPIRATION_HOURS = config('api_constants.CLIENT_AUTH_TOKEN_EXPIRATION_HOURS');
        ...
        if($user_auth_token == ""){
            ...
            // if($enable_multiple_device_login == "Yes"){
                ...
                $req_user_id      = (isset($request_param['client_id']) && $request_param['client_id'] != "" ? $request_param['client_id'] : 0);
