...
{
    protected $table = 'mas_school_type';
    ...
    public static function getSemesterDataList($semester_id = NULL) {
        $query = DB::table('mas_school_type');
    ...
    public static function getSemesterData($iDisplayLength = NULL, $iDisplayStart = NULL, $sort = NULL, $sortdir = NULL, $search = NULL, $search_arr = array()) {
        $query = DB::table('mas_school_type as mi');
        $query->select('mi.*');
    ...
    */
    public static function getSemesterDataFromId($id) {
        $query = self::select('mas_school_type.*');
        if(is_array($id)){
            $query->whereIn('id', $id);
        }else {
            $query->where(['mas_school_type.id' => $id]);
        }
    ...
    */
     ...
     */
    public static function getSchoolTypeDataList() {
        $query = DB::table('mas_school_type');
