...
{
    protected $table = 'client_login_log'; 
     ...
     */
    public static function addClientLoginLog($insert_array)
    {
     ...
     */
    public static function updateClientLoginLog($id, $update_array)
    {
        return self::where('id', $id)->update($update_array);
    }

    public static function getClientLoginData($where_arr)
    {
     ...
     * @return array 
    */
    public static function CountClientTotalLoginLogs($user_id_array)
    {
     ...
     * @return   boolean       
     */
    public static function deleteClientLoginLog($user_id, $device_type=null)
    {
     ...
     * @return mixed
     */
    public static function getClientLogin($where_arr)
    {
        $query = self::from('user_login_log');
