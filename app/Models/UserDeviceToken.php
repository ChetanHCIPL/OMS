...
class UserDeviceToken extends Model
{
     ...
     * @return   array       
     */
    public static function addUserDeviceToken($insert_array)
    {
     ...
     * @return   boolean       
     */
    public static function updateUserDeviceToken($id, $update_array)
    {
     ...
     * @return   boolean       
     */
    public static function deleteUserDeviceToken($user_id)
    {
     ...
     * @return   array  $data       
     */
    public static function getUserDeviceToken($where_array)
    {
        $query = self::select('*');
