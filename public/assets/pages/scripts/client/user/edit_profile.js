...
var FormValidation = function () {
    ...
    var handleValidation = function () {
        ...
        form.validate({
            ...
            messages: {
                client_name: {required: "Enter name", minlength: "Enter at least 3 characters for name.", maxlength: "Enter maximum 100 characters for name."},
                email: {required: "Enter email", email: "Enter valid email", maxlength: "Enter maximum 100 characters for email."},
                mobile_number: {required: "Enter Mobile Number", maxlength: "Enter maximum 10 characters for mobile number."},
