$('#datatable_list').DataTable({
    ...
    "ajax": assets + "/" + panel_text + "/user_discount_category/data",
	"columns": [
    ...
    var handleValidation = function () {
        ...
        form.validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: assets  + "/" +  panel_text + '/user_discount_category/data',
                    data: formData,
                    contentType: false,
                    cache: false,
                    processData: false,
...
function add_edit_modal(id, mode) {
    ...
    if (mode == "Add") {
        ...
        $('#id').val(id);
        $('#user_discount_category').val($("#gname" + id).html());
...
function clearfieldvalue() {
    ...
    $('#section').closest('.form-group').removeClass('has-error');
}
