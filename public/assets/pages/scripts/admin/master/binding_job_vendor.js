$('#datatable_list').DataTable({
    ...
    "ajax": assets + "/" + panel_text + "/binding_job_vendor/data",
	"columns": [
    ...
    var handleValidation = function () {
        ...
        form.validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: assets  + "/" +  panel_text + '/binding_job_vendor/data',
                    data: formData,
                    contentType: false,
                    cache: false,
                    processData: false,
...
function add_edit_modal(id, mode) {
    ...
    if (mode == "Add") {
        ...
        $('#id').val(id);
        $('#binding_job_vendor').val($("#gname" + id).html());
        $("#address").val($("#gaddress" + id).html());
...
function clearfieldvalue() {
    ...
    $('#print_job_vendor').closest('.form-group').removeClass('has-error');
}
