...
var FormValidation = function () {
    ...
    var handleValidation = function () {
        ...
        form.validate({
            ...
            messages: {
                district_name: {required: "Enter district name.", minlength: "Enter atleast 2 characters for district name.", maxlength: "Enter maximum 100 characters for district name."},
                country_id: {required: "Select country."},
                district_code: {required: "Enter district code.", minlength: "Enter atleast 2 characters for district code.", maxlength: "Enter maximum 5 characters for district code."},
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: assets + "/" +panel_text + '/districts/data',
                    data: formData,
                    contentType: false,
                    cache: false,
                    processData: false,
