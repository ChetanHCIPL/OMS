...
$('#datatable_list').DataTable({
    ...
    "ajax": assets + "/" + panel_text + "/accountyear/data",
	"columns": [
    ...
    var handleValidation = function () {
        ...
        form.validate({
            ...
            messages: {
                ...
                auto_approve_limit: {required: "Enter Auto Approval Limit"},
            },
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: assets  + "/" +  panel_text + '/accountyear/data',
                    data: formData,
                    contentType: false,
                    cache: false,
                    processData: false,
...
function add_edit_modal(id, mode) {
    ...
    if (mode == "Add") {
        ...
        $('#id').val(id);
        $('#grade').val($("#gname" + id).html());
        $('#auto_approval_limit').val($("#glimit" + id).html());
