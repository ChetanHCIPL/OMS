$(document).ready(function() { 
    ...
    var product_board = $('#product_board').val();
    $('#datatable_list').DataTable({
        ...
        //"ajax": assets + "/" + panel_text + "/medium/data",
        "ajax": {
              "data":{"_token":csrf_token,'product_board':product_board},
              "url": assets + "/" + panel_text + "/medium/data",
          },
        "columns": [
...
function add_edit_modal(id, mode) {
    ...
    if (mode == "Add") {
        ...
        $('#mode_title').text('Edit');
        $('#id').val(id);
        $('#medium').val($("#gname" + id).html());
...
function clearfieldvalue() {
    ...
    $('#medium').closest('.form-group').removeClass('has-error');
}
