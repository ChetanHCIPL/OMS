$('#datatable_list').DataTable({
    ...
    "ajax": assets + "/" + panel_text + "/auditstockreason/data",
	"columns": [
    ...
    var handleValidation = function () {
        ...
        form.validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: assets  + "/" +  panel_text + '/auditstockreason/data',
                    data: formData,
                    contentType: false,
                    cache: false,
                    processData: false,
...
function add_edit_modal(id, mode) {
    ...
    if (mode == "Add") {
        ...
        $('#id').val(id);
        $('#auditstockreason').val($("#gname" + id).html());
...
function clearfieldvalue() {
    ...
    $('#auditstockreason').closest('.form-group').removeClass('has-error');
}
