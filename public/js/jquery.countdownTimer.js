    ...
    function givenDate($this, opts, type) {
        ...
        if ((endDate - startDate) > 0) {
            ...
            if(days == "00"){
                ...
                html($this, days + ' day ' + hours + opts.timeSeparator + minutes + opts.timeSeparator + seconds);                
            }else{
                html($this, days + ' days ' + hours + opts.timeSeparator + minutes + opts.timeSeparator + seconds);                
            }
