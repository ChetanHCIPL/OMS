...
@section('content')
@php
  $section_arr = Config::get('constants.sms_template_section');
@endphp
<div class="content-wrapper">
	<div class="content-body">
		<section class="content-header clearfix">
		  <h3>{{$mode}} SMS Template<strong><span class="text-muted accent-3">{{isset($data[0]['type'])?' - '.$data[0]['type']:''}}</span></strong></h3>
		  <ol class="breadcrumb">
			<li><a href="javascript:void(0);">Dashboard</a></li>
			<li><a href="javascript:void(0);">Tools</a></li>
			<li><a href="{{route('sms-template/grid')}}">SMS Template</a></li>
      <li class="active">{{(isset($mode)?$mode:'') }} SMS Template</li>
		  </ol>
		</section>
              ...
              <div class="card-head ">
                <div class="card-header">
                  <div class="float-right">
                      ...
                      <a href="{{route('sms-template',['mode' => 'view', 'id' => gen_generate_encoded_str($data[0]['id'], '3', '3', '')])}}" title="View"><span class="btn btn-icon btn-secondary btn-light waves-effect waves-light"><i class="la la-eye"></i></span></a>
                      @endif
                  </div>
                </div>
              </div>
                      ...
                      <div id="accordionWrap5" role="tablist" aria-multiselectable="true">
                        <div class="card collapse-icon accordion-icon-rotate">
                          <div id="heading51" class="card-header">
                            <a data-toggle="collapse" href="#accordion51" aria-expanded="true" aria-controls="accordion51" class="card-title lead">SMS Tempalte</a>
                          </div>
                        ...
                        <div class="col-xl-4 col-12">
                         ...
                         @endif
          					...
          					<div class="form-actions text-right">
          					  <a href="{{route('sms-template/grid')}}">
...
<script src="{{ asset('/assets/pages/scripts/admin/tools/sms_template_add.js')}}" type="text/javascript"></script>
