              ...
              <div class="card-header">
                <div class="float-right">
                 @if(per_hasModuleAccess('SMSTemplate','Edit'))
                    <a href="{{route('sms-template',['mode' => 'edit', 'id' => isset($data[0]['id'])?gen_generate_encoded_str($data[0]['id'], '3', '3', ''):''])}}" title="Edit"><span class="btn btn-icon btn-secondary waves-effect waves-light"><i class="la la-edit"></i></span></a>
                  @endif
                </div>
              </div>
            </div>
				<div class="card-content collapse show">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" aria-expanded="true" role="tabpanel" aria-expanded="true"  id="tab_1"  aria-labelledby="base-tab_1">
                      ...
                      <a href="{{route('sms-template/grid')}}"><button type="button" class="btn mr-1"><i class="material-icons">chevron_left</i>Back</button></a>
                    </div>
                  </div>
                  </div>
      				  </div>	
