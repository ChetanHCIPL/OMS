    ...
    <div class="content-body">
        <section class="content-header clearfix">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Email Tempaltes</li>
            </ol>
        </section>
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="card-header  border-bottom search-filter-header">
                            <h4 class="card-title"><i class="material-icons">email</i> Email Template Listing</h4>
	                                ...
	                                <div class="filter mr-1 float-left">
	                                 ...
	                                 <div class="btn-group">  
                                            ...
                                            <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'email-template');">
                                                        <span>Active</span>
                                                    </a>
                                                    <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'email-template');">
                                                        <span>Inactive</span>
                                                    </a>
                                            </div>
                                        
                                        @endif
                                        @if (per_hasModuleAccess('EmailTemplate', 'Add')) 
                                            &nbsp;&nbsp;
                        					<a href="{{ route('email-template',['mode'=>'add']) }}" class="btn btn-primary btn-sm waves-effect waves-light" title="Create Template"><i class="ft-plus "></i>
                            ...
                            <ul class="nav nav-tabs nav-top-border no-hover-bg" id="secttab">
                                    @if(isset($section_arr))
                                        @foreach($section_arr as $k=>$v)
		                                    <li class="nav-item">
		                                       <a ria-selected="true" class="nav-link" data-toggle="tab" href="#tab_{{$k}}" id="{{$k}}" role="tab">{{$v}}</a>
		                                    </li>
	                                    @endforeach
	                                 @endif
                            </ul>
...
<script src="{{ asset('/assets/pages/scripts/admin/tools/email_template_list.js')}}" type="text/javascript"></script>
