    ...
    <div class="content-body">
        <section class="content-header clearfix">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">WhatsApp Tempaltes</li>
            </ol>
        </section>
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="card-header  border-bottom search-filter-header">
                            <h4 class="card-title"><i class="fa-brands fa-whatsapp"></i> WhatsApp Template Listing</h4>
                                ...
                                <div class="btn-group">
	                                ...
	                                <div class="btn-group"> 
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'whatsapp-template');">
                                                <span>Active</span>
                                            </a>
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'whatsapp-template');">
                                                <span>Inactive</span>
                                            </a>
                                        </div>
                                        @endif
...
<script src="{{ asset('/assets/pages/scripts/admin/tools/whatsapp_template_list.js')}}" type="text/javascript"></script>
