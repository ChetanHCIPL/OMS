                                          ...
                                          <div id="accordion51" role="tabpanel" data-parent="#accordionWrap5" aria-labelledby="heading51" class="card-collapse collapse show" aria-expanded="true">
                                             <div class="card-body">
                                                <ul class="nav nav-tabs m-0">
                                                   ...
                                                   <?php /*
                                                   <li class="nav-item">
                                                      <a class="nav-link" id="base-tab_5" data-toggle="tab" aria-controls="tab_5" href="#tab_5" aria-expanded="False">Sales User</a>
                                                   </li>
                                                   <?php */?>
                                                   <li class="nav-item">
                                             ...
                                             <div class="row">
                                                <div class="form-body  col-md-12">
                                                   ...
                                                   <div class="form-group row mx-auto m-1">
                                                      ...
                                                      <div class="col-md-5 custom-file px-0 h-auto">
                                                         <div class="img_upload_block">
                                                            <input type="file" id="image" class="custom-file-input form-control"  name="image" value="{{ isset($userData['image']) ? $userData['image'] : old('image') }}" >
                                                            <label class="custom-file-label" for="image" aria-describedby="imageAddon">Choose file</label>
                                                         </div>
                                                         <div class="user_imgold_block">
                                                            <input type="hidden" name="user_image_old" value="{{ isset($userData['image']) ? $userData['image'] : '' }}" >
                                                            <span class="text-danger">
                                                               {{ $errors->first('image') }}
                                                            </span>
                                                         </div>
                                                         <div class="img_uploaddanger_block">
                                                            @if(isset($img_ext_array) && !empty($img_ext_array))
                                                            <p class="danger m-0">[ Valid extentions: <code>{{!empty($img_ext_array)?$img_ext_array:''}}</code>]</p>
                                                            @endif
                                                         </div>
                                                      </div>
                                                   ...
                                                   <div class="form-group row mx-auto">
                                                      <label class="col-md-3 label-control" for="sales_structure_id">Sales Structure <span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                         <select id="sales_structure_id" class="access_control" name="sales_structure_id" >
                                                            ...
                                                            <option value="{{ $structure['id'] }}"
                                                               ...
                                                               <?php
                                                                   ...
                                                                   ?>
                                                               >{{$structure['full_name']}} ({{ $structure['short_name'] }})
                                                            </option>
                                                            @endforeach
                                                            @endif
                                                         </select>
                                                         <span class="text-danger">{{$errors->first('sales_structure_id') }}</span>
                                                      </div>
                                                   </div>
                                                   <div class="form-group row mx-auto">
                                                      <label class="col-md-3 label-control"  for="aadhar_no">Aadhar Number <span class="required" aria-required="true">*</span></label>
                                                   ...
                                                   {{-- <div class="form-group row mx-auto">
                                                      <label class="col-md-3 label-control" for="designation">Designation <span class="required">*</span></label>
                                                      <div class="col-md-9">
                                          ...
                                          <div class="sales_structure">
                                                ...
                                                <div class="form-group row mx-auto {{ (!($mode=='Update' && $userData['sales_structure_id']==1))? 'd-none':''}}" id="div_sales_state">
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         @if(!empty($stateDatalist))
                                                            @foreach($stateDatalist as $state)
                                                            <option value="{{ $state['id'] }}" {{ ($mode=='Update' && $userData['sales_structure_id']==1 && in_array($state['id'],$rsm_state))? 'selected':''}} >{{ $state['state_name']}}
                                                            </option>
                                                            @endforeach
                                                            @endif 
                                                         </select>
                                                   ...
                                                   <div class="form-group row mx-auto {{ (!($mode=='Update' && $userData['sales_structure_id']>=2))? 'd-none':''}}" id="div_rsm_state">
                                                      <label class="col-md-3 label-control">State&nbsp;<span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                         <select  id="user_type_rsm_state" class="access_control_noorder" name="user_type_rsm_state" >
                                                            <option value="">Select State</option>
                                                            @if(!empty($stateDatalist))
                                                               @foreach($stateDatalist as $state)
                                                               <option value="{{ $state['id'] }}" {{ ($mode=='Update' &&  in_array($state['id'],$rsm_state))? 'selected':''}}>{{ $state['state_name']}}
                                                               </option>
                                                               @endforeach
                                                            @endif 
                                                         </select>
                                                ...
                                                <div class="form-group row mx-auto {{ (!($mode=='Update' && $userData['sales_structure_id']==2))? 'd-none':''}}" id="div_rsm_zone" >
                                                      <label class="col-md-3 label-control">Zone&nbsp;<span class="required">*</span></label>
                                                   <div class="col-md-9">
                                                      <select  id="user_type_rsm_zone" class="access_control" data-selected="{{(!empty($zsmdata[0]['zone_id']))? $zsmdata[0]['zone_id']:''}}" name="user_type_rsm_zone" >
                                                         <option value="">Select Zone</option>
                                                         @if(!empty($zonelist))
                                                            @foreach($zonelist as $z)
                                                             <option value="{{$z['id']}}" {{(!empty($zsmdata[0]['zone_id']) && $z['id']==$zsmdata[0]['zone_id'])? 'selected':''}}>{{$z['zone_name']}}</option>
                                                            @endforeach
                                                         @endif
                                                      </select>
                                                ...
                                                <div class="form-group row mx-auto {{ (!($mode=='Update' && $userData['sales_structure_id']>=3))? 'd-none':''}}" id="div_zsm" >
                                                      <label class="col-md-3 label-control">ZSM&nbsp;<span class="required">*</span></label>
                                                      <div class="col-md-9"><!--- North vs south ----->
                                                         <select  id="user_type_zsm" class="access_control" name="user_type_zsm" >
                                                            <option value="">Select ZSM</option>
                                                            @if(!empty($zsml))
                                                                  @foreach($zsml as $v)
                                                                  <option value="{{$v['id']}}" {{(!empty($zsmdata[0]['zsm_id']) && $v['id']==$zsmdata[0]['zsm_id'])? 'selected':''}}>{{$v['name']}}</option>
                                                                  @endforeach
                                                            @endif
                                                         </select>
                                                         <span class="text-danger">{{ $errors->first('user_type_rsm') }}</span> 
                                                      </div>
                                                   </div>
                                                <div class="form-group row mx-auto {{ (!($mode=='Update' && $userData['sales_structure_id']>=4))? 'd-none':''}}" id="div_dy_zsm" >
                                                      <label class="col-md-3 label-control">DY ZSM </label>
                                                      <div class="col-md-9">
                                                         <select  id="user_type_dyzsm" class="access_control" name="user_type_dyzsm" >
                                                            <option value="">Select DY ZSM</option>
                                                            @if($mode == 'Update')
                                                               @if(!empty($dyzsm))
                                                               @foreach($dyzsm as $dzm)
                                                                  <option value="{{$dzm['id']}}" {{(!empty($zsmdata[0]['dy_zsm_id']) && $dzm['id']==$zsmdata[0]['dy_zsm_id'])? 'selected':''}}>{{$dzm['name']}}</option>
                                                               @endforeach
                                                               @endif
                                                            @endif
                                                        </select>
                                                         <span class="text-danger">{{$errors->first('user_type_dyzsm') }}</span> 
                                                      </div>
                                                </div>
                                                   <div class="form-group row mx-auto {{ (!($mode=='Update' && $userData['sales_structure_id']>=5))? 'd-none':''}}" id="div_asm_dy_zsm" >
                                                      <label class="col-md-3 label-control">ASM&nbsp;<span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                         <select  id="user_type_asm" class="access_control" name="user_type_asm" >
                                                            <option value="">Select ASM</option>
                                                            @if(!empty($asmlist))
                                                               @foreach($asmlist as $a)
                                                                  <option value="{{$a['id']}}" {{(!empty($zsmdata[0]['asm_id']) && $a['id']==$zsmdata[0]['asm_id'])? 'selected':''}}>{{$a['name']}}</option>
                                                               @endforeach
                                                            @endif
                                                        </select>
                                                      </div>
                                                   </div>
                                                <div class="form-group row mx-auto {{ (!($mode=='Update' && ($userData['sales_structure_id']==3 || $userData['sales_structure_id']==4)))? 'd-none':''}}" id="div_zsm_district" >
                                                      <label class="col-md-3 label-control">District&nbsp;<span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                         <select id="user_type_zsm_district" class="access_control" multiple  name="user_type_zsm_district[]" >
                                                         <option value="">Select District</option>
                                                         @if($mode == 'Update')
                                                            @foreach($zsm_district as $d)
                                                            <option value="{{$d['id']}}" {{ (!empty($seletedzsm_district) && in_array($d['id'],$seletedzsm_district))? 'selected':''}}>{{$d['district_name']}}</option>
                                                            @endforeach
                                                         @endif                                          
                                                         </select>
                                                     ...
                                                     <div class="form-group row mx-auto {{ (!($mode=='Update' && $userData['sales_structure_id']>=5))? 'd-none':''}}" id="div_aso_asm_district" >
                                                      <label class="col-md-3 label-control">Taluka&nbsp;<span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                         <select id="user_type_aso_asm_taluka" class="access_control" name="user_type_aso_asm_taluka" >
                                                            <option value="">Select Taluka</option>
                                                            @if(!empty($talukalist))
                                                               @foreach($talukalist as $t)
                                                                  <option value="{{$t['id']}}" {{ (!empty($selectedtaluka) && in_array($t['id'],$selectedtaluka))? 'selected':''}}>{{$t['taluka_name']}}</option>
                                                               @endforeach
                                                            @endif
                                                        </select>
                                                      </div>
                                             ...
                                             <div class="row">
                                                <div class="form-body">
                                                   ...
                                                   <div class="form-group row mx-auto">
                                                      <label class="col-md-3 label-control">State <span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                         <select  id="state_id" class="access_control" name="state_id" >
                                                            <option value="">Select State</option>
                                                            @if(!empty($stateData))
                                                   ...
                                                   <div class="form-group row mx-auto">
                                                      <label class="col-md-3 label-control">{{-- Districts --}}District <span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                         <select  id="districts_id" class="access_control" name="districts_id" >
                                                   ...
                                                   <div class="form-group row mx-auto">
                                                      <label class="col-md-3 label-control" for="taluka">Taluka <span class="required">*</span></label>
                                                      <div class="col-md-9">
                                             ...
                                             <div class="row">
                                                <div class="form-body">
                                                   ...
                                                   <div class="form-group row mx-auto changePassDiv d-none" id="password" >
                                                      ...
                                                      <div class="col-md-9 position-relative has-icon-right password-input password">
                                                         ...
                                                         <a href="javascript:void(0)" title="show password" class="form-control-position" onclick="showhidePassword(this,'password');"><span class="btn btn-icon btn-secondary btn-light  waves-effect waves-light"><i class="la la-eye"></i></span></a>
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group row mx-auto changePassDiv d-none" id="password_confirmation">
                                                      ...
                                                      <div class="col-md-9 position-relative has-icon-right password-input confirm_password">
                                                         ...
                                                         <a href="javascript:void(0)" title="show password" class="form-control-position pwd_eyes_btn" onclick="showhidePassword(this,'confirm_password');"><span class="btn btn-icon btn-secondary btn-light  waves-effect waves-light"><i class="la la-eye"></i></span></a>
                                                      </div>
                                                   </div>
                                                   @else 
                                                   <div class="form-group row mx-auto">
                                                      ...
                                                      <div class="col-md-9  position-relative has-icon-right password-input">
                                                         ...
                                                         <a href="javascript:void(0)" title="show password" class="form-control-position pwd_eyes_btn" onclick="showhidePassword(this);"><span class="btn btn-icon btn-secondary btn-light  waves-effect waves-light"><i class="la la-eye"></i></span></a>
...
<script type="text/javascript">
   ...
   var talukaList = "{{ route('taluka/talukalist') }}";
   var route_user_add ="{{ route('sales.usersave') }}"; 
   var adduser = "{{ route('salesuser',['mode'=>'add']) }}";
   var list = "{{ route('admin.user') }}";
   var salesulist="{{route('sales.saleslist')}}";
   var removeimage = "{{ route('admin.user.removeimage') }}";
   var zoneajax="{{route('zone/zoneajax')}}";
...
<!-- End FORM VALIDATION -->
<script src="{{ asset('assets/pages/scripts/admin/sales/salesuseradd.js?ver=1') }}"></script>
@endsection