    ...
    <div class="content-wrapper">
        <div class="content-body">
            <section class="content-header clearfix">
                   <h3>User<strong><span class="text-muted accent-3">{{(isset($userData[0]['first_name'])?' - '.$userData[0]['first_name']:'')}}{{(isset($userData[0]['last_name'])?' '.$userData[0]['last_name']:'')}}</span></strong></h3>
                  <ol class="breadcrumb">
                            ...
                            <div class="card-head">
                                <div class="card-header">
                                  ...
                                  @if (per_hasModuleAccess('Users', 'Edit')) 
                                        ...
                                        <a href="{{ route('user',['mode'=>'edit','id'=>isset($userData[0]['id'])?base64_encode($userData[0]['id']):'']) }}" title="Edit"><span class="btn btn-icon btn-secondary waves-effect waves-light"><i class="la la-edit"></i></span></a> 
                                  @endif
                                                                            ...
                                                                            <div class="form-group row mx-auto">
                                                                                ...
                                                                                <div class="form-group row mx-auto">
                                                                                    <label class="col-md-3 ">Taluka</label>
                                                                                     <div class="col-md-9 label-control">
                                                                                  {{isset($talukaData['taluka_name']) && $talukaData['taluka_name'] != '' ? $talukaData['taluka_name'] : '--' }}
                                                                                     </div>
                                                                                </div>
                                                                                 
                                                                            <div class="form-group row mx-auto"> 
                                                                                <label class="col-md-3 "  for="userinput2">Area</label>
                                                                                <div class="col-md-9 label-control">
                                                                                   {{ (isset($userData[0]['area']) && $userData[0]['area'] != '') ? $userData[0]['area']  : '--'}}
                                                                                </div> 
                                                                            </div> 
                                                                          <div class="form-group row mx-auto"> 
