                ...
                <div class="card">
                    <div class="card-head">
                        <div class="card-header  border-bottom search-filter-header">
                            ...
                            <h4 class="card-title"><i class="material-icons">person_outline</i> Users List</h4>
                            ...
                            <div class="heading-elements">
                                ...
                                <div class="btn-group">  
                                    ...
                                    @if (per_hasModuleAccess('Users', 'Edit') || per_hasModuleAccess('Users', 'Delete'))                                 
                                    ...
                                    <div class="dropdown-menu">
                                        @if(per_hasModuleAccess('Users', 'Edit'))
                                                <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'user','updatestatus');">Active</a>
                                                <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'user','updatestatus');">Inactive</a>
                                        @endif 
                                        @if(per_hasModuleAccess('Users', 'Delete'))
                                                <a id="userMultiDelete"  class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('delete', 'user','multipledelete');">Delete</a>
                                           
                                        @endif
                                         @endif
                                    </div>
                                    @if(per_hasModuleAccess('Users', 'Add'))&nbsp;&nbsp;
                                        <a href="{{ route('user',['mode'=>'add']) }}" class="btn btn-primary btn-sm waves-effect waves-light" title="Create User"><i class="ft-plus "></i> Create User</a>
                                    @endif
                                    @if(per_hasModuleAccess('Users', 'Add'))&nbsp;&nbsp;
...
<script type="text/javascript">
  var userajaxlist = "{{ route('admin.userajaxlist') }}"; 
