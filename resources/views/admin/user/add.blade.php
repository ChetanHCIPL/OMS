    ...
    <div class="content-wrapper">
        <div class="content-body">
            <section class="content-header clearfix">
                   <h3>User<strong><span class="text-muted accent-3">{{(isset($userData['first_name'])?' - '.reduceTitleName($userData['first_name']):'')}}{{(isset($userData['last_name'])?' '.$userData['last_name']:'')}}</span></strong></h3>
                  <ol class="breadcrumb">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="javascript:void(0);">Admin</a></li>
                    <li><a href="javascript:void(0);">User Mgmt</a></li>
                    <li><a href="{{ route('admin.user') }}">Users</a></li>
                    <li class="active">{{(isset($mode)?$mode:'') }} User</li>
                  </ol>
            </section> 
                                ...
                                <div class="card-header">
                                  ...
                                  @if($mode == 'Update')
                                    @if (per_hasModuleAccess('Users', 'View')) 
                                        <a href="{{ route('user',['mode'=>'view','id'=>base64_encode($userData['id'])]) }}" title="View"><span class="btn btn-icon btn-secondary btn-light waves-effect waves-light"><i class="la la-eye"></i></span></a> 
                                        @endif
                                        @if(per_hasModuleAccess('Users', 'Delete')) 
                                        <a onclick="deleteSingleRecord({{isset($userData['id'])?$userData['id']:''}},'user');" title="Delete"><span class="btn btn-icon btn-danger waves-effect waves-light"><i class="la la-trash"></i></span></a>  
                                        @endif
                                    @endif
                                                        ...
                                                        <div id="accordionWrap5" role="tablist" aria-multiselectable="true">
                                                          <div class="card collapse-icon accordion-icon-rotate">
                                                            <div id="heading51" class="card-header">
                                                              <a data-toggle="collapse" href="#accordion51" aria-expanded="true" aria-controls="accordion51" class="card-title lead">User</a>
                                                            </div>
                                                                  ...
                                                                  <div class="row">
                                                                    ...
                                                                    <div class="form-group row mx-auto"> 
                                                                      ...
                                                                      <div class="form-group row mx-auto m-1"> 
                                                                        ...
                                                                        <div class="col-md-6 custom-file px-0 h-auto">
                                                                     ...
                                                                     <select  id="acess_groupid" class="access_control" name="acess_groupid" > 
                                                                        ...
                                                                        @if(!empty($access_group_data))
                                                                          ...
                                                                          @foreach($access_group_data as $rowGroup)
                                                                            ...
                                                                            @if($mode == 'Add')
                                                                              <option value="{{ $rowGroup['id'] }}">{{ $rowGroup['access_group'] }}</option>
                                                                            @elseif($mode == 'Update')
                                                                               @php $grp_exp = array(); @endphp
                                                                                @if(isset($userData['access_group_id_arr']) && $userData['access_group_id_arr'] != "") 
                                                                                   @php $grp_exp = array_filter(explode(',', $userData['access_group_id_arr'])); @endphp
                                                                  ...
                                                                  <div class="form-body"> 
                                                                    <div class="form-group row mx-auto">
                                                                      <label class="col-md-3 label-control">Country <span class="required">*</span></label>
                                                                        <div class="col-md-9">
                                                                          ...
                                                                          @foreach($countryData as $key => $countryArray)
                                                                             @if($mode == 'Update')
                                                                                <option value="{{ $countryArray->id }}" {{($countryArray->id ==$userData['country_id'])?'selected':''}}>{{ $countryArray->country_name }}</option>
                                                                              @elseif($mode == 'Add')
                                                                                @php $def_country = (isset($default_country)?$default_country:"")@endphp
                                                                                <option value="{{ $countryArray->id }}" {{($countryArray->id ==$def_country)?'selected':''}} >{{ $countryArray->country_name }}</option>
                                                                              @endif
                                                                            @endforeach
                                                                          </select> 
                                                                                      ...
                                                                                      @if($mode == 'Update')
                                                                                         @if(!empty($stateData))
                                                                                              @foreach($stateData as $sArry)
                                                                                                  <option value="{{ $sArry['id'] }}" {{ $sArry['id'] == $userData['state_id'] ? 'selected' : '' }}>{{ $sArry['state_name']}}</option>
                                                                                              @endforeach
                                                                                         @endif 
                                                                                      @endif 
                                                                                      </select> 
                                                                          ...
                                                                          <div class="form-group row mx-auto">
                                                                              <label class="col-md-3 label-control">Districts <span class="required">*</span></label>
                                                                               <div class="col-md-9">
                                                                      ...
                                                                      <div class="form-group row mx-auto"> 
                                                                          ...
                                                                          <div class="col-md-9">
                                                                              <input type="text" id="area" class="form-control " placeholder="Area" name="area" value="{{ isset($userData['area']) ? $userData['area'] : old('area') }}" >
...
<script src="{{ asset('assets/pages/scripts/admin/user/useradd.js') }}"></script>
@endsection