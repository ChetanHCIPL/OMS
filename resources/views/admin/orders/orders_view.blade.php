...
<div class="content-wrapper">
   <div class="content-body">
      <section class="content-header clearfix">
         <h3>View Order #<strong>{{$data[0]['order_no']}}</strong></h3>
         <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li><a href="javascript:void(0);">Orders Mgmt</a></li>
            <li><a href="{{route('orders/list')}}">Order</a></li>
            <li><a href="javascript:void(0);">Create Order</a></li>
         </ol>
      </section>
                           ...
                           <div class="row">
                              <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                 <div class="container-fluid">
                                          ...
                                          <table class="table table-striped">
                                             <thead>
                                                <tr>
                                                   ...
                                                   <th class="text-center" width="10%" scope="col">Order Quantity</th>
                                                   <th class="text-center" width="10%" scope="col">Bill Quantity</th>
                                                   <th class="text-center" width="10%" scope="col">Dispatch Quantity</th>
                                                   <th class="text-right" width="10%" scope="col">MRP</th>
                                                   <th class="text-center" width="10%" scope="col">Available Quantity</th>
                                                </tr>
                                             </thead>
                                             <tbody>
                                                @if(!empty($order_product_data))
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="text-center">{{$product['bill_qty']}}</td>
                                                      <td class="text-center">{{$product['bill_qty']}}</td>
                                                      <td class="text-right">₹&nbsp;{{number_format($product['final_amount'],2)}}</td>
                                                ...
                                                <table class="table table-bordered table-striped">
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td><b class="total-weight">10.000</b></td>
                                                      </tr>
                                                      <tr>
                                                         <td class="text-right">Total Dispatch Weight</td>
                                                         <td><b class="total-quantity">10.000</b></td>
                                                      </tr>
                                                   </tbody>
                                                </table>   
                                             </div>
                                    ...
                                    <div class="form-actions text-right"><a href="{{route('orders/list')}}">
