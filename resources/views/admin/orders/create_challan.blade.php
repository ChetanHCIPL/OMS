    ...
    <div class="content-body">
		<section class="content-header clearfix">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Order Challan</li>
			</ol>
		</section>
                ...
                <div class="card">
                    <div class="card-head ">
                        <div class="card-header border-bottom  search-filter-header">
                            <h4 class="card-title"><i class="material-icons">local_mall</i> Order Challan Listing</h4>
...
<script src="{{ asset('/assets/pages/scripts/admin/orders/create_challan.js')}}" type="text/javascript"></script>
