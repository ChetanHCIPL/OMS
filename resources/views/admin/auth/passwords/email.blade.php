                ...
                <div class="card-content border-radius-10 pt-0">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-12 text-center text-md-right"><a href="{{route('admin.login')}}" class="card-link">Back to login?</a></div>
                        </div>
                        <button type="submit" class="custom_login_btn btn btn-block btn-lg"><i class="ft-unlock"></i> Request Reset Link</button>
                    </form>
                    </div>
                </div>
            </div>
