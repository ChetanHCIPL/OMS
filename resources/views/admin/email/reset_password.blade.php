...
<div><a href="<?php echo route('password.reset.token',['token' => $token]);?>" style="font-family:Avenir, Helvetica, sans-serif;color:#FFF;text-decoration:none;background-color:#3097D1;border-top:10px solid #3097D1;border-right:18px solid #3097D1;border-bottom:10px solid #3097D1;border-left:18px solid #3097D1;" class="button button-blue">Reset Password</a></div><br/><br/>
