                ...
                <div class="card">
                    <div class="card-head">
                        <div class="card-header border-bottom search-filter-header">
                            <h4 class="card-title"><i class="material-icons">list_alt</i> Payment Terms</h4>
                                ...
                                <div class="btn-group">
                                   @if (per_hasModuleAccess('PaymentTerms', 'Edit'))
                                    ...
                                    <div class="dropdown-menu">
                                       @if(per_hasModuleAccess('PaymentTerms', 'Delete'))
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'paymentterms');">Active</a>
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'paymentterms');">Inactive</a>
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'paymentterms');">Delete</a>
                                        @endif
                                    </div>
                                    @endif
                                    @if(per_hasModuleAccess('PaymentTerms', 'Add'))
                                    &nbsp;&nbsp;<a href="javascript:void(0)" id="add_edit_modal" onclick="add_edit_modal('', 'Add')" class="btn btn-primary btn-sm waves-effect waves-light" title="Create Payment Terms"><i class="ft-plus "></i> Create Payment Terms</a>
                                    @endif
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2 col-sm-12" data-column="0">
                                                        <input type="text" class="column_filter form-control" name="term" id="col0_filter" placeholder="Payment Terms"> 
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 col-sm-12" data-column="1">
                                                        <select class="column_filter selectize-select form-control" name="due_type" id="col1_filter" placeholder="Select Due Type">
                                                            <option value="">Select Due Type</option>
                                                            <option value="1">Fixed number of days</option>
                                                            <option value="2">Certain day of month</option>
                                                        </select>
                                                    </div>
...
<button type="button" class="btn btn-outline-info block btn-lg d-none" id="add_modal_box" data-toggle="modal" data-target="#add_paymentterms">Launch Modal</button>
<div class="modal fade text-left" id="add_paymentterms" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-focus-on="input:first" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success white">
                <h3 class="modal-title white" id="myModalLabel"><span id="mode_title"></span> Payment Terms </h3>
           ...
           <input type="hidden" id="customActionName" name="customActionName" value="{{(isset($mode)?$mode:'') }}" />
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <label for="ip">Payment Terms <span class="required">*</span></label>
                        <div class="controls">
                            <div class="form-group">
                                <input type="text" placeholder="Payment Terms" id="paymentterms" name="term" class="form-control" maxlength="150" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <label for="due_type">Due Type <span class="required"></span></label>
                        <div class="controls">
                            <div class="form-group">
                               <input type="checkbox" class="switchBootstrap" id="due_type" name="due_type" data-on-text="FND" data-off-text="CDM" data-on-color="{{Config::get('constants.switch_on_color')}}" data-off-color="{{Config::get('constants.status_color.Running')}}" value="1"
                                {{((isset($data[0]['due_type']) && $data[0]['due_type'] == 1 ) ?'checked':($mode == 'Add')?'checked':'') }}/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mt-2" style="font-size: 12px;">
                        FND : Fixed number of days<br>
                        CDM : Certain day of month
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <label for="ip">Due Days <span class="required">*</span></label>
                        <div class="controls">
                            <div class="form-group">
                                <input type="text" placeholder="Due Days" id="due_type_value" name="due_type_value" class="form-control" maxlength="3" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- End Bootstrap Switch -->
<script src="{{ asset('assets/pages/scripts/admin/master/paymentterms_list.js')}}" type="text/javascript"></script>
