            ...
            <div class="card">
               <div class="card-head">
                  <div class="card-header border-bottom search-filter-header">
                     <h4 class="card-title"><i class="material-icons">local_shipping</i> Transporter</h4>
                     <div class="heading-elements">
                        ...
                        <div class="btn-group">
                           ...
                           <div class="dropdown-menu">
                              @if(per_hasModuleAccess('Transporter', 'Delete'))
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'transporter');">Active</a>
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'transporter');">Inactive</a>
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'transporter');">Delete</a>
                              @endif
                           </div>
                           @endif
                           @if (per_hasModuleAccess('Transporter', 'Add'))
                           &nbsp;&nbsp;<a href="{{route('transporter',['mode' => 'add', 'id' => ''])}}" class="btn btn-primary btn-sm waves-effect waves-light" title="Create Transporter"><i class="ft-plus "></i> Create Transporter </a>@endif
                        </div>
                     </div>
                  </div>
               </div>
...
<!--End Selectize-->
<script src="{{ asset('assets/pages/scripts/admin/master/transporter_list.js')}}" type="text/javascript"></script>
