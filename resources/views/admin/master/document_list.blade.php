            ...
            <div class="card">
               <div class="card-head">
                  <div class="card-header border-bottom search-filter-header">
                     <h4 class="card-title"><i class="material-icons">list_alt</i> Document List</h4>
                     <div class="heading-elements">
                        ...
                        <div class="btn-group">
                           @if (per_hasModuleAccess('Documents', 'Edit') || per_hasModuleAccess('Documents', 'Delete'))
                           ...
                           <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'documents');">Active</a>
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'documents');">Inactive</a>
                              @endif

                              @if(per_hasModuleAccess('Documents', 'Delete'))
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'documents');">Delete</a>
                              @endif
                           </div>
                           @endif
                           @if(per_hasModuleAccess('Documents', 'Add'))
                           &nbsp;&nbsp;<a href="javascript:void(0)" id="add_edit_modal" onclick="add_edit_modal('', 'Add')" class="btn btn-primary btn-sm waves-effect waves-light" title="Create Document"><i class="ft-plus "></i> Create Document</a>
                           @endif
                        </div>
                     </div>
                  </div>
                                 ...
                                 <div class="col-md-12">
                                    <div class="row">
                                       <div class="col-md-2 col-sm-12" data-column="0">
                                          <input type="text" class="column_filter form-control" name="title" id="col0_filter" placeholder="Document"> 
                                       </div>
...
<button type="button" class="btn btn-outline-info block btn-lg d-none" id="add_modal_box" data-toggle="modal" data-target="#add_grade">Launch Modal</button>
<div class="modal fade text-left" id="add_grade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-focus-on="input:first" data-backdrop="static" data-keyboard="false">
   <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
         <div class="modal-header bg-success white">
            <h3 class="modal-title white" id="myModalLabel"><span id="mode_title"></span> Document </h3>
            ...
            <div class="modal-body">
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="controls">
                        <div class="form-group">
                           <input type="text" placeholder="Title" id="title" name="title" class="form-control" maxlength="150" required>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="controls">
                        <div class="form-group">
                           <input type="number" placeholder="Display Order" id="display_order" name="display_order" class="form-control" required>
                        </div>
                     </div>
                  </div>
               </div>
...
<!-- End Bootstrap Switch -->
<script src="{{ asset('assets/pages/scripts/admin/master/document_list.js')}}" type="text/javascript"></script>
