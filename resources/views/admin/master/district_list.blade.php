...
@endsection
@section('content')
    @php $_statuesArray = $currentClass->_districtModel->renderDistrictStatus();@endphp
					...
					<div class="card">
						<div class="card-head">
                        	<div class="card-header border-bottom  search-filter-header">
                        		<h4 class="card-title"><i class="material-icons">location_city</i> {{-- District --}}District Listing</h4>
                        		...
                        		<div class="heading-elements">
                        			...
                        			<div class="btn-group">
                        				 @if(per_hasModuleAccess('Districts', 'Edit') || per_hasModuleAccess('Districts', 'Delete'))
                        					...
                        					<div class="dropdown-menu">
                        						 @if(per_hasModuleAccess('Districts','Edit'))
                        							<a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'districts');">
                        								<span>Active</span>
                        							</a>
                        							<a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'districts');">
                        								<span>Inactive</span>
                        							</a>
                        						  @endif
                        						  @if(per_hasModuleAccess('Districts', 'Delete'))
                        							<a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'districts');">
                        								<span>Delete</span>
                        							</a>
                        						@endif
                        					</div>
                        				@endif
                        				@if(per_hasModuleAccess('Districts','Add'))
                                            &nbsp;&nbsp;
                        					<a href="{{route('districts',['mode' => 'add', 'id' => ''])}}" class="btn btn-primary btn-sm waves-effect waves-light" title="Create {{-- District --}}District"><i class="ft-plus "></i>
                        					 	<span>Create {{-- District --}}District</span>
                        					</a>
                        				@endif
                        			</div>
                        		</div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-2 col-sm-12" data-column="0">
                                                            <input type="text" class="column_filter form-control" name="district_name" id="col0_filter" placeholder="{{-- District --}}District Name">
                                                        </div>
                                                        <div class="col-md-2 col-sm-12" data-column="1">
                                                            <input type="text" class="column_filter form-control" name="district_code" id="col1_filter" placeholder="{{-- District --}}District Code">
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-sm-12" data-column="3">
                                                            <input type="text" class="column_filter form-control" name="zone_name" id="col3_filter" placeholder="Zone">
                                                        </div>
                                         ...
                                         <table class="table table-striped table-bordered table-hover" id="datatable_list" width="100%">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="20%"> {{-- District --}}District Name </th>
                                                    <th width="10%"> {{-- District --}}District Code </th>
...
<script src="{{ asset('/assets/pages/scripts/admin/master/district_list.js')}}" type="text/javascript"></script>
