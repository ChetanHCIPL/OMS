...
<div class="content-wrapper">
    <div class="content-body">
		<section class="content-header clearfix">
			<h3>{{-- District --}}District<strong><span class="text-muted accent-3">{{(isset($data[0]['district_name'])?' - '.$data[0]['district_name']:'')}} </span></strong></h3> 
			<ol class="breadcrumb">
				<li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
				<li><a href="javascript:void(0);">Master Mgmt</a></li>
				<li><a href="{{route('districts/grid')}}">{{-- District --}}District</a></li>
				<li><a href="javascript:void(0);">{{(isset($mode)?$mode:'') }} {{-- District --}}District</a></li>
			</ol>
		</section>
			                ...
			                <div class="card-header">
								<div class="float-right">
									...
									@if(per_hasModuleAccess('Districts','Edit'))
										<a href="{{route('districts',['mode' => 'edit', 'id' => isset($data[0]['id'])?base64_encode($data[0]['id']):''])}}" title="Edit"><span class="btn btn-icon btn-secondary waves-effect waves-light"><i class="la la-edit"></i></span></a>
									@endif
								</div>
							</div>
						</div>
                                                ...
                                                <div id="accordionWrap5" role="tablist" aria-multiselectable="true">
                                                    <div class="card collapse-icon accordion-icon-rotate">
                                                        <div id="heading51" class="card-header">
                                                            <a data-toggle="collapse" href="#accordion51" aria-expanded="true" aria-controls="accordion51" class="card-title lead">{{-- District --}}District</a>
                                                        </div>
                                                    		...
                                                    		<div class="row">
						                                    	<div class="form-body">
																	<div class="form-group row mx-auto">
																		<label class="col-md-3">Default {{-- District --}}District Name </label>
																		<div class="col-md-9 label-control">
																			{{(isset($data[0]['district_name'])?$data[0]['district_name']:'---')}}
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																		<label class="col-md-3">{{-- District --}}District Code </label>
																		<div class="col-md-9 label-control">
																		    {{(isset($data[0]['district_code'])?$data[0]['district_code']:'---')}}
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
