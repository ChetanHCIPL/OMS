			                ...
			                <div class="card-header">
								<div class="float-right">
									...
									@if(per_hasModuleAccess('Cities','Edit'))
										<a href="{{route('city',['mode' => 'edit', 'id' => isset($data[0]['id'])?base64_encode($data[0]['id']):''])}}" title="Edit"><span class="btn btn-icon btn-secondary waves-effect waves-light"><i class="la la-edit"></i></span></a>
									@endif
								</div>
							</div>
						</div>
                                                    		...
                                                    		<div class="row">
						                                    	<div class="form-body">
																	<div class="form-group row mx-auto">
																		<label class="col-md-3">Default {{-- City --}}District Name </label>
																		<div class="col-md-9 label-control">
																			{{(isset($data[0]['city_name'])?$data[0]['city_name']:'---')}}
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																		<label class="col-md-3">{{-- City --}}District Code </label>
																		<div class="col-md-9 label-control">
																		    {{(isset($data[0]['city_code'])?$data[0]['city_code']:'---')}}
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																		...
																		<div class="col-md-9 label-control">
																				...
																				@if (isset($data[0]['state_code']))
																					@foreach ($state as  $value)
																						@if( in_array($data[0]['state_code'], $value))
																						@php
							                                ...
							                                <div class="col-md-12">
							                                  <div class="form-group row mx-auto"> 
							                                    <label class="col-md-12 label-control">
							                                      <h6 class="tab-content-title">{{-- City --}}District Name </h6>
							                                    </label>
							                                  </div>
							                                  ...
							                                  <div class="form-group row mx-auto">
							                                      <label class="col-md-3">
							                                        <img class="flag"  onerror="isImageExist(this)" noimage="80x80.jpg" id="show-image" src="{{$language[$i]['Image']}}" alt=""/> {{$language[$i]['lang_name']}} 
							                                      </label>
							                                      <div class="col-md-9 label-control" >
							                                        {{(isset($city_language[$language[$i]['lang_code']])?$city_language[$language[$i]['lang_code']]:"---")}}
							                                      </div>
							                                  </div>
