...
<div class="content-wrapper">
  <div class="content-body">
	...
	<section class="content-header clearfix">
		<h3>{{(isset($mode)?$mode:'') }} Product Head <strong><span class="text-muted accent-3">{{((isset($data[0]['name'])?' - '.$data[0]['name']:''))}}</span></strong></h3>
		<ol class="breadcrumb">
          ...
          <div class="card">
            ...
            <a href="{{route('producthead/grid')}}">
             ...
             @if (per_hasModuleAccess('ProductHead', 'Edit'))
						<a href="{{route('producthead',['mode' => 'edit', 'id' => isset($data[0]['id'])?gen_generate_encoded_str($data[0]['id'], '3', '3', ''):''])}}" title="Edit"><span class="btn btn-icon btn-secondary waves-effect waves-light"><i class="la la-edit"></i></span></a>
            @endif
					</div>
				 </div>
			  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-10 col-lg-9 col-md-12 col-12">
                      <div class="tab-content">
                        ...
                        <div class="tab-pane" aria-expanded="true" role="tabpane2" aria-expanded="true"  id="tab_2"  aria-labelledby="base-tab_2">
                          <div class="row">
							<div class="col-xl-12">
								<h3 class="tab-content-title">Categories</h3>
							</div>
						  </div>
                          <div class="row">
                            <div class="col-xl-8">
                              <div class="row">
                                ...
                                @if(isset($categories) && is_array($categories))
                                    ...
                                    <div class="form-group row mx-auto">
                                        ...
                                        <div class="col-md-9 label-control">
                                        @if(isset($prepared_cat) && array_key_exists($category['id'], $prepared_cat)){{$prepared_cat[$category['id']]['max_discount']}}@endif %
                                        </div>
                                    </div>
                                    @endforeach
                                  @endif
