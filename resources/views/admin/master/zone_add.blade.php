...
<div class="content-wrapper">
    <div class="content-body">
		<section class="content-header clearfix">
			...
			<h3>Zone<strong><span class="text-muted accent-3">{{(isset($data[0]['zone_name'])?' - '.$data[0]['zone_name']:'')}} </span></strong></h3>

			<ol class="breadcrumb">
				<li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
				<li><a href="javascript:void(0);">Master Mgmt</a></li>
				<li><a href="{{route('zone/grid')}}">Zone</a></li>
				<li><a href="javascript:void(0);">{{(isset($mode)?$mode:'') }} Zone</a></li>
			</ol>
		</section>
        <section class="horizontal-grid zone-edit-page" id="horizontal-grid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
			                ...
			                <div class="card-header">
								<div class="float-right">
									...
									@if(per_hasModuleAccess('Zone','View'))
										<a href="{{route('zone',['mode' => 'view', 'id' => isset($data[0]['id'])?base64_encode($data[0]['id']):''])}}" title="View"><span class="btn btn-icon btn-secondary btn-light waves-effect waves-light"><i class="la la-eye"></i></span></a>
									@endif										
								</div>
							</div>
						</div>
                                    ...
                                    <div class="row">
                                                ...
                                                <div id="accordionWrap5" role="tablist" aria-multiselectable="true">
                                                    <div class="card collapse-icon accordion-icon-rotate">
                                                        <div id="heading51" class="card-header">
                                                            <a data-toggle="collapse" href="#accordion51" aria-expanded="true" aria-controls="accordion51" class="card-title lead">Zone</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-md-12 col-12">
                                        	<div class="tab-content">
                                                    		...
                                                    		<div class="row">
						                                    	<div class="form-body">
																	<div class="form-group row mx-auto">
																		<label class="col-md-3 label-control">Zone Name <span class="required">*</span></label>
																		<div class="col-md-9">
																			<input class="form-control" placeholder="Zone Name" type="text" id="zone_name" name="zone_name" value="{{(isset($data[0]['zone_name'])?$data[0]['zone_name']:'')}}">
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																		<label class="col-md-3 label-control">Zone Code <span class="required">*</span></label>
																		<div class="col-md-9">
																			<input class="form-control" placeholder="Zone Code" type="text" id="zone_code" name="zone_code" value="{{(isset($data[0]['zone_code'])?$data[0]['zone_code']:'')}}">
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																	...
																	<div class="form-group row mx-auto">
																		...
																		<div class="col-md-9">
																			...
																			@else
																				@php $checked = ((isset($data[0]['status']) && $data[0]['status'] == $currentClass->_zoneModel::ACTIVE )?'checked':''); @endphp
																			@endif
                                                ...
                                                <div class="form-actions text-right"><a href="{{route('zone/grid')}}">
...
<script src="{{ asset('/assets/pages/scripts/admin/master/zone_add.js')}}" type="text/javascript"></script>
