            ...
            <div class="card">
               <div class="card-head">
                  <div class="card-header border-bottom search-filter-header">
                     <h4 class="card-title"><i class="material-icons">bar_chart</i> Grade</h4>
                     <div class="heading-elements">
                        ...
                        <div class="btn-group">
                           @if (per_hasModuleAccess('Grade', 'Edit'))
                           ...
                           <div class="dropdown-menu">
                              @if(per_hasModuleAccess('Grade', 'Delete'))
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'grade');">Active</a>
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'grade');">Inactive</a>
                              <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'grade');">Delete</a>
                              @endif
                           </div>
                           @endif
                           @if(per_hasModuleAccess('Grade', 'Add'))
                           &nbsp;&nbsp;<a href="javascript:void(0)" id="add_edit_modal" onclick="add_edit_modal('', 'Add')" class="btn btn-primary btn-sm waves-effect waves-light" title="Create Grade"><i class="ft-plus "></i> Create Grade</a>
                           @endif
                        </div>
                     </div>
                  </div>
                                 ...
                                 <div class="col-md-12">
                                    <div class="row">
                                       <div class="col-md-2 col-sm-12" data-column="0">
                                          <input type="text" class="column_filter form-control" name="name" id="col0_filter" placeholder="Grade"> 
                                       </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatable_list" width="100%">
                           ...
                           <thead>
                              <tr role="row" class="heading">
                                 ...
                                 <th width="30%">Name</th>
                                 <th width="10%">Auto Approval Limit</th>
   ...
   <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
         <div class="modal-header bg-success white">
            <h3 class="modal-title white" id="myModalLabel"><span id="mode_title"></span> Grade </h3>
         ...
         <form name="frmadd" id="frmadd" action="">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-md-12">
                     <label for="grade">Name <span class="required">*</span></label>
                     <div class="controls">
                        <div class="form-group">
                           <input type="text" placeholder="Name" id="grade" name="name" class="form-control" maxlength="150" required>
                        </div>
                     </div>
                  </div>
               </div>
...
<!-- End Bootstrap Switch -->
<script src="{{ asset('assets/pages/scripts/admin/master/grade_list.js')}}" type="text/javascript"></script>
