...
<div class="content-wrapper listing-innerpage">
    <div class="content-body">
		<section class="content-header clearfix">
			<h3>Audit Stock Reason</h3>
			<ol class="breadcrumb">
				<li><a href="javascript:void(0);">Dashboard</a></li>
                <li><a href="javascript:void(0);">Master Mgmt</a></li>
				<li class="active">Audit Stock Reason</li>
			</ol>
		</section>
                ...
                <div class="card">
                    <div class="card-head">
                        <div class="card-header border-bottom search-filter-header">
                            <h4 class="card-title"><i class="material-icons">list_alt</i> Audit Stock Reason</h4>
                                ...
                                <div class="btn-group">
                                   @if (per_hasModuleAccess('AuditStockReason', 'Edit'))
                                    ...
                                    <div class="dropdown-menu">
                                       @if(per_hasModuleAccess('AuditStockReason', 'Delete'))
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'auditstockreason');">Active</a>
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'auditstockreason');">Inactive</a>
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'auditstockreason');">Delete</a>
                                        @endif
                                    </div>
                                    @endif
                                    @if(per_hasModuleAccess('AuditStockReason', 'Add'))
                                    &nbsp;&nbsp;<a href="javascript:void(0)" id="add_edit_modal" onclick="add_edit_modal('', 'Add')" class="btn btn-primary btn-sm waves-effect waves-light" title="Create Audit Stock Reason"><i class="ft-plus "></i> Create Audit Stock Reason</a>
                                    @endif
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2 col-sm-12" data-column="0">
                                                        <input type="text" class="column_filter form-control" name="title" id="col0_filter" placeholder="Audit Stock Reason"> 
                                                    </div>
...
<button type="button" class="btn btn-outline-info block btn-lg d-none" id="add_modal_box" data-toggle="modal" data-target="#add_auditstockreason">Launch Modal</button>
<div class="modal fade text-left" id="add_auditstockreason" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-focus-on="input:first" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success white">
                <h3 class="modal-title white" id="myModalLabel"><span id="mode_title"></span> Audit Stock Reason </h3>
           ...
           <input type="hidden" id="customActionName" name="customActionName" value="{{(isset($mode)?$mode:'') }}" />
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <label for="ip">Audit Stock Reason <span class="required">*</span></label>
                        <div class="controls">
                            <div class="form-group">
                                <input type="text" placeholder="Audit Stock Reason" id="auditstockreason" name="title" class="form-control" maxlength="150" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- End Bootstrap Switch -->
<script src="{{ asset('assets/pages/scripts/admin/master/auditstockreason_list.js')}}" type="text/javascript"></script>
