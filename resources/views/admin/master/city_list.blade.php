...
@endsection
@section('content')
    @php $_statuesArray = $currentClass->_cityModel->renderCityStatus();@endphp
		...
		<div class="content-body">
			<section class="content-header clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">{{-- City --}}District</li>
				</ol>
			</section>
					...
					<div class="card">
						<div class="card-head">
                        	<div class="card-header border-bottom  search-filter-header">
                        		<h4 class="card-title"><i class="material-icons">location_city</i> {{-- City --}}District Listing</h4>
                        		...
                        		<div class="heading-elements">
                        			...
                        			<div class="btn-group">
                        				 @if(per_hasModuleAccess('Cities', 'Edit') || per_hasModuleAccess('Cities', 'Delete'))
                        					...
                        					<div class="dropdown-menu">
                        						 @if(per_hasModuleAccess('Cities','Edit'))
                        							<a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'city');">
                        								<span>Active</span>
                        							</a>
                        							<a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'city');">
                        								<span>Inactive</span>
                        							</a>
                        						  @endif
                        						  @if(per_hasModuleAccess('Cities', 'Delete'))
                        							<a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'city');">
                        								<span>Delete</span>
                        							</a>
                        						@endif
                        					</div>
                        				@endif
                        				@if(per_hasModuleAccess('Cities','Add'))
                                            &nbsp;&nbsp;
                        					<a href="{{route('city',['mode' => 'add', 'id' => ''])}}" class="btn btn-primary btn-sm waves-effect waves-light" title="Create {{-- City --}}District"><i class="ft-plus "></i>
                        					 	<span>Create {{-- City --}}District</span>
                        					</a>
                        				@endif
                        			</div>
                        		</div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-2 col-sm-12" data-column="0">
                                                            <input type="text" class="column_filter form-control" name="city_name" id="col0_filter" placeholder="{{-- City --}}District Name">
                                                        </div>
                                                        <div class="col-md-2 col-sm-12" data-column="1">
                                                            <input type="text" class="column_filter form-control" name="city_code" id="col1_filter" placeholder="{{-- City --}}District Code">
                                                        </div>
                                                        <div class="col-md-2 col-sm-12" data-column="2">
                                                            <input type="text" class="column_filter form-control" name="country_code" id="col2_filter" placeholder="Country Code">
                                                        </div>
                                                        <div class="col-md-2 col-sm-12" data-column="3">
                                                            <input type="text" class="column_filter form-control" name="state_code" id="col3_filter" placeholder="State Code">
                                                        </div>
                                                    </div>
                                                </div>
                                         ...
                                         <table class="table table-striped table-bordered table-hover" id="datatable_list" width="100%">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="20%"> {{-- City --}}District Name </th>
                                                    <th width="10%"> {{-- City --}}District Code </th>
                                                    <th width="13%"> Country Code </th>
                                                    <th width="8%"> State Code </th>
...
<script src="{{ asset('/assets/pages/scripts/admin/master/city_list.js')}}" type="text/javascript"></script>
