...
<div class="content-wrapper">
    <div class="content-body">
        ...
        <section class="horizontal-grid zone-view-page" id="horizontal-grid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                    	<div class="card-head ">
			                <div class="card-header">
								<div class="float-right">
									...
									@if(per_hasModuleAccess('Zone','Edit'))
										<a href="{{route('zone',['mode' => 'edit', 'id' => isset($data[0]['id'])?base64_encode($data[0]['id']):''])}}" title="Edit"><span class="btn btn-icon btn-secondary waves-effect waves-light"><i class="la la-edit"></i></span></a>
									@endif
								</div>
							</div>
						</div>
                                                    		...
                                                    		<div class="row">
						                                    	<div class="form-body">
																	<div class="form-group row mx-auto">
																		<label class="col-md-3">Default Zone Name </label>
																		<div class="col-md-9 label-control">
																			{{(isset($data[0]['zone_name'])?$data[0]['zone_name']:'---')}}
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																		<label class="col-md-3">Zone Code </label>
																		<div class="col-md-9 label-control">
																		    {{(isset($data[0]['zone_code'])?$data[0]['zone_code']:'---')}}
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
