                ...
                <div class="card">
                    <div class="card-head">
                        <div class="card-header border-bottom search-filter-header">
                            <h4 class="card-title"><i class="material-icons">my_location</i> Ip</h4>
                                ...
                                <div class="btn-group">
                                   @if (per_hasModuleAccess('Ip', 'Edit'))
                                    ...
                                    <div class="dropdown-menu">
                                       @if(per_hasModuleAccess('Ip', 'Delete'))
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Active', 'ip');">Active</a>
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Inactive', 'ip');">Inactive</a><a class="dropdown-item" href="javascript:void(0);" onclick="return checkAction('Delete', 'ip');">Delete</a>
                                        @endif
                                    </div>
                                    @endif
                                    @if(per_hasModuleAccess('Ip', 'Add'))
                                    &nbsp;&nbsp;<a href="javascript:void(0)" id="add_edit_modal" onclick="add_edit_modal('', 'Add')" class="btn btn-primary btn-sm waves-effect waves-light" title="Create ip"><i class="ft-plus "></i> Create Ip</a>
                                    @endif
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2 col-sm-12" data-column="0">
                                                        <input type="text" class="column_filter form-control" name="ipdescription" id="col0_filter" placeholder="description"> 
                                                    </div>
                                                    <div class="col-md-2 col-sm-12" data-column="1">
                                                        <input type="text" class="column_filter form-control" name="ipIp" id="col1_filter" placeholder="IP address"> 
                                                    </div>
...
<button type="button" class="btn btn-outline-info block btn-lg d-none" id="add_modal_box" data-toggle="modal" data-target="#add_ip">Launch Modal</button>
<div class="modal fade text-left" id="add_ip" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-focus-on="input:first" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success white">
                <h3 class="modal-title white" id="myModalLabel"><span id="mode_title"></span> IP </h3>
...
<!-- End Bootstrap Switch -->
<script src="{{ asset('assets/pages/scripts/admin/ip/ip_list.js')}}" type="text/javascript"></script>
