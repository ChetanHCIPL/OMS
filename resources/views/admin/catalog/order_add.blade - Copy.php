                              ...
                              <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                 <div class="container-fluid">
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <div class="form-group mx-auto" style="display:none;" id="address">
                                             <div class="form-group row mx-auto">
                                                ...
                                                <small class="col-md-3 label-control">Address3 :</small>
                                                <div class="col-md-9">
                                                   <small class="label-control">Mithakhali Six Road</small>
                                                </div>
                                                <small class="col-md-3 label-control">City :</small>
                                                <div class="col-md-9">
                                          ...
                                          <div class="form-group row mx-auto">
                                             <label class="label-control col-md-3">Contact Name & Number <span class="required">*</span></label>
                                             <div class="col-md-8">
                                          ...
                                          <div class="form-group row mx-auto">
                                             ...
                                             <div class="col-md-8">
                                                <select class="custom-select form-control" id="sales_name" name="sales_name" placeholder="Sales Name ">
                                                   ...
                                                   <option value="s1">Salesman 1</option>
                                                   <option value="s2">Salesman 2</option>
                                                   <option value="s3">Salesman 3</option>
                                                </select>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <div id="ftr" style = "display:none">
                                             <div class="form-group row mx-auto">
                                                <label class="label-control col-md-3">Medium <span class="required">*</span></label>
                                                <div class="col-md-9">
                                             ...
                                             <div class="form-group row mx-auto">
                                                <label class="label-control col-md-3">Std / Segment <span class="required">*</span></label>
                                                <div class="col-md-9">
                                             ...
                                             <div class="form-group row mx-auto">
                                                <label class="label-control col-md-3">Series (Mentor) <span class="required">*</span></label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row mt-2">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group row mx-auto">
                                             <label class="label-control col-md-3" for="payment_due_days">Payment Due Days</label>
                                             <div class="col-md-3">
