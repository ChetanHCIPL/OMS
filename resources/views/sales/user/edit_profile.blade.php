                        ...
                        <div class="card-content collapse show">
                            <div class="card-body language-input">
                                <form class="form form-horizontal" id="frmadd" name="frmadd" enctype="multipart/form-data" action="">
                                    ...
                                    <input type="hidden" id="admin_id" name="admin_id" value="{{ (isset($admin_id)?$admin_id:"") }}" />
                                                    		...
                                                    		<div class="row">
                                                    			<div class="form-body">
																	<div class="form-group row mx-auto">
																		<label class="col-md-3 label-control">First Name <span class="required">*</span></label>
																		<div class="col-md-9">
																			<input class="form-control" placeholder="First Name" type="text" id="first_name" name="first_name" value="{{ (isset($data[0]->first_name)?$data[0]->first_name:old('first_name'))}}">
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																		<label class="col-md-3 label-control">Last Name <span class="required">*</span></label>
																		<div class="col-md-9">
																			<input class="form-control" placeholder="Last Name" type="text" id="last_name" name="last_name" value="{{ (isset($data[0]->last_name)?$data[0]->last_name:old('last_name'))}}">
																		</div>
																	</div>
																	<div class="form-group row mx-auto">
																	...
																	<div class="form-group row mx-auto">
																		...
																		<div class="col-md-9 position-relative has-icon-left">
																		  <input class="form-control" placeholder="Mobile" type="text" id="mobile" name="mobile" value="{{ (isset($data[0]->mobile)?$data[0]->mobile:old('mobile'))}}" maxlength="10">
																		  <div class="form-control-position">
...
<script type="text/javascript">
    ...
    var panel_text = '<?php echo Config::get("constants.SALES_PANEL_PREFIX"); ?>'; 
</script>
<!-- BEGIN PAGE LEVEL PLUGINS -->
...
<script src="{{ asset('/assets/pages/scripts/admin/user/edit_profile.js')}}" type="text/javascript"></script>
