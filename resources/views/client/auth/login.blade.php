                    ...
                    <div class="card border-grey border-lighten-3 m-0 border-radius-10">
                        <div class="card-header border-0 border-radius-10">
                            <div class="card-title text-center">
                                <img src="{{asset('/images/logo/logo.png')}}" alt="IdealOMS" title="" >
                            </div>
                            <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Login To Client Panel</span></h6>
                        </div>
                        <div class="card-content border-radius-10 pt-0">
                            <div class="card-body p-0">
                                ...
                                @endif
                                <form class="form-horizontal" action="{{ route('client.auth') }}" method="POST" novalidate>
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12 col-12 text-center text-md-right">   
                                            <a href="{{route('client.password.resets')}}" class="card-link">Forgot Password?</a>
                                        </div>
                                    </div>
